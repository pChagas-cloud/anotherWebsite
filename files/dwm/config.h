...
static const char *fonts[]          = { "JetBrains Mono:size=10", "fontawesome:size=12", "JoyPixels:pixelsize=12:antialias=true:autohint=true"};
static const char dmenufont[]       = "JetBrains Mono:size=10";

#include "/home/chagu/.cache/wal/colors-wal-dwm.h"

//tag names (upper left)
static const char *tags[] = { ">_", "www", "<->", "0-0", "UwU",  "6", "7", "8"};
